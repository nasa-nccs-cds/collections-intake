...
class AvirisDataSource(DataSourceMixin, PatternMixin):
    """Open a collection of Aviris files as an xarray.
    ...
    def __init__(self, urlpath, chunks=None, concat_dim='concat_dim', xarray_kwargs=None, metadata=None, path_as_pattern=True, **kwargs):
        ...
        self._ds = None
        super(AvirisDataSource, self).__init__(metadata=metadata, **kwargs)
